<!-- Fashion Theme Product Grid -->
<section id="products" class="py-3 py-md-4">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h3 class="fw-bold mb-0 fs-5 fs-md-3">New Collection</h3>
                <p class="text-muted small mb-0 d-none d-sm-block">Trending fashion items</p>
            </div>
            <span class="badge bg-dark text-light px-2.5 py-1.5 rounded-pill font-weight-bold">
        ...
        <?php if (empty($products)): ?>
            <div class="text-center py-5 bg-white rounded-4 border p-4">
                ...
                <h6 class="fw-bold">No Products Available</h6>
            </div>
        <?php else: ?>
                ...
                <?php foreach ($products as $prod): ?>
                    <div class="store-product-card">
                        ...
                        <div class="store-product-body">
                            <span class="store-product-category"><?= sanitize($prod['category_name'] ?? 'Fashion') ?></span>
