...
<section id="products" class="py-4">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="fw-bold mb-1">New Collection</h3>
                <p class="text-muted small mb-0">Trending fashion items</p>
            </div>
            <span class="badge bg-dark text-light px-3 py-2 rounded-pill font-weight-bold">
