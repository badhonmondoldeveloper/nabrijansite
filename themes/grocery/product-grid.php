...
<section id="products" class="py-3 py-md-4">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <h3 class="fw-bold mb-0 fs-5 fs-md-3">Everyday Essentials</h3>
                <p class="text-muted small mb-0 d-none d-sm-block">Fresh produce & grocery items</p>
            </div>
        ...
        <?php if (empty($products)): ?>
            <div class="text-center py-5 bg-white rounded-4 border p-4">
                ...
                <h6 class="fw-bold">No Items Available</h6>
            </div>
        <?php else: ?>
