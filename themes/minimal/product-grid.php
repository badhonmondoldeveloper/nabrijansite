...
<section id="products" class="py-4">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="fw-bold mb-1">Our Products</h3>
                <p class="text-muted small mb-0">Browse quality items with instant delivery</p>
            </div>
        ...
        <?php if (empty($products)): ?>
            <div class="text-center py-5 bg-white rounded-4 border p-5">
                ...
                <p class="text-muted">No items available matching your selection right now.</p>
            </div>
        <?php else: ?>
