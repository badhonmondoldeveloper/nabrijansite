...
<section id="products" class="py-4">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h3 class="fw-bold mb-1">Featured Electronics</h3>
                <p class="text-muted small mb-0">Original tech with warranty</p>
            </div>
            <span class="badge bg-primary text-white px-3 py-2 rounded-pill font-weight-bold">
        ...
        <?php if (empty($products)): ?>
            <div class="text-center py-5 bg-white rounded-4 border p-5">
                ...
                <h5 class="fw-bold">No Electronics Available</h5>
            </div>
        <?php else: ?>
