...
<head>
    ...
    <title><?= sanitize($pageTitle ?? 'Forgot Password - Nabrijan') ?></title>
...
<body>
    <div class="auth-card">
        ...
        <h5 class="text-center text-light mb-2">Reset Password</h5>
        <p class="text-center text-secondary small mb-4">Enter your registered email address to receive password reset instructions.</p>
        ...
        <form action="/forgot-password" method="POST">
            ...
            <button type="submit" class="btn btn-primary-custom w-100 mt-2">Send Reset Link</button>
        </form>
